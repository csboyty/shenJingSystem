...
var functions=(function(config){
    ...
    return {
        ...
        getInfo: function (type) {
            var obj = {}, name, val;
            $("*[data-name-parent='" + type + "']").each(function (index, el) {
                el = $(el);
                name = el.attr("name");
        ...
        saveInfo: function (url, data, callback) {
        ...
        uploadFile: function (el, callback) {
            var fd = new FormData();
            el = el[0];
...
$(document).ready(function(){
    $(".ctrl").change(function(){
        var targetPanelId=$(this).data("control-panel");
